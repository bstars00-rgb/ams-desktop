...
const DEFAULTS = {
  ...
  aiMinScore: 80, // only AI-verify candidates at/above this score (skip low ones)
  aiBatchSize: 8, // verify this many rooms per single API call (fewer requests, cheaper)
